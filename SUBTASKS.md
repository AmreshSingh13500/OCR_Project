...
|---|---|---|---|---|
| T1.1.1 | Create repo layout per plan §2 + `requirements.txt` with pinned deps | PENDING | — | — |
| T1.1.2 | `config.py` via pydantic-settings; fail fast on missing env vars | PENDING | — | — |
| T1.1.3 | `utils/logging.py` — JSON logs with case_id/message_id correlation | PENDING | — | — |
